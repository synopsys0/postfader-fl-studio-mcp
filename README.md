...
| Windows | Windows 11 x64 implementation, CI, installer, diagnostics, packaging, and v0.20 deterministic coverage are complete; supervised FL/virtual-MIDI validation is still pending. |
