...
| Setup guide | [docs/setup.md](https://github.com/synopsys0/postfader-fl-studio-mcp/blob/dev/docs/setup.md) |
| Tool contracts | [docs/tool-contracts.md](https://github.com/synopsys0/postfader-fl-studio-mcp/blob/dev/docs/tool-contracts.md) |
| Sound Selection | [docs/sound-selection.md](https://github.com/synopsys0/postfader-fl-studio-mcp/blob/dev/docs/sound-selection.md) |
| Creation Pipeline | [docs/creation-pipeline.md](https://github.com/synopsys0/postfader-fl-studio-mcp/blob/dev/docs/creation-pipeline.md) |
| Creation Review | [docs/creation-review.md](https://github.com/synopsys0/postfader-fl-studio-mcp/blob/dev/docs/creation-review.md) |
| Next-release notes | [docs/releases/dev-v10.md](https://github.com/synopsys0/postfader-fl-studio-mcp/blob/dev/docs/releases/dev-v10.md) |
| Security policy | [SECURITY.md](https://github.com/synopsys0/postfader-fl-studio-mcp/blob/dev/SECURITY.md) |
| Plug-in matrix | [docs/plugin-matrix.md](https://github.com/synopsys0/postfader-fl-studio-mcp/blob/dev/docs/plugin-matrix.md) |
