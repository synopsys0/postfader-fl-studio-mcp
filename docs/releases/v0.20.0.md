...
The [development branch](https://github.com/synopsys0/postfader-fl-studio-mcp/tree/dev)
now has 134 tools and 8 resources. Its additions include Plugin Atlas, Sound
Selection, Production Runs with durable recovery, Creation Review and delivery,
Piano Roll note inspection, native macOS plug-in loading, and saved-FLP WAV
rendering. These features are **not included in v0.20.0 assets**. Live acceptance
for the new note-inspection and renderer paths remains pending. Read the
[development notes](https://github.com/synopsys0/postfader-fl-studio-mcp/blob/dev/docs/releases/dev-v10.md)
for current capabilities and limitations.

## What is new in v0.20.0?

v0.20.0 ships the following production surface:
...
2. Install v0.20.0 and deploy the matching v0.20 Universal Bridge by running
   ...
   [setup guide](https://github.com/synopsys0/postfader-fl-studio-mcp/blob/v0.20.0/docs/setup.md).
...
while learning the write workflow. See the [security policy](https://github.com/synopsys0/postfader-fl-studio-mcp/blob/v0.20.0/SECURITY.md)
and [tool contracts](https://github.com/synopsys0/postfader-fl-studio-mcp/blob/v0.20.0/docs/tool-contracts.md) for the full boundaries.
...
- [Setup and troubleshooting](https://github.com/synopsys0/postfader-fl-studio-mcp/blob/v0.20.0/docs/setup.md)
- [Tool and command reference](https://github.com/synopsys0/postfader-fl-studio-mcp/blob/v0.20.0/docs/tool-contracts.md)
- [Plug-in support](https://github.com/synopsys0/postfader-fl-studio-mcp/blob/v0.20.0/docs/plugin-support.md)
- [Security policy](https://github.com/synopsys0/postfader-fl-studio-mcp/blob/v0.20.0/SECURITY.md)
