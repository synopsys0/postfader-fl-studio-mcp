...
REQUIRED_CREATION_REVIEW_PATHS = {
...
SYNTHETIC_WAVS = {
    ...
    "tests/fixtures/creation_review/clean_baseline.wav": (
        256_044,
        "19a3a8a80a036174c36f3e7561954ee1b41c7215805e8c43d6f2c4307e5c7a0d",
    ),
    "tests/fixtures/creation_review/clipped_candidate.wav": (
        256_044,
        "9ed74e8c73e9129a12edb902b4232662b35e9f224ce559da8b61b1e83ac3e66a",
    ),
    "tests/fixtures/creation_review/duration_mismatch.wav": (
        192_044,
        "1d18934bd370ce3bda5d0f20c78f02b17e2d2575af60876b8583ea205da7e0a5",
    ),
    "tests/fixtures/creation_review/improved_contrast_with_regression.wav": (
        256_044,
        "9c6966aae228b9284d5da290efb41ae56ea46af5016be6c6c9d380c65ba53038",
    ),
    "tests/fixtures/creation_review/low_mid_heavy_candidate.wav": (
        256_044,
        "d05392f8eb227ab101421b54457ea15c3288fb925061022c068101d85c019bd8",
    ),
    "tests/fixtures/creation_review/masking_instrumental_stem.wav": (
        256_044,
        "2b9ca8ea9d27c10929d21e7a9e504347fe09da427cad62d55af6f12158944ad9",
    ),
    "tests/fixtures/creation_review/masking_vocal_stem.wav": (
        256_044,
        "db0013545d4177cb6bc344b36af76d31a200ba134cf8e65dd9ac4ecaa47cceec",
    ),
    "tests/fixtures/creation_review/offset_candidate.wav": (
        256_044,
        "012329ebacdfdb5889bee99f6f8f85f33cf89f49e75d1fef54ecc788f878d3b6",
    ),
    "tests/fixtures/creation_review/overly_bright_candidate.wav": (
        256_044,
        "9b229ce2e2501cc6de5445075f2f689dd47295a7da45c2fdcc8d88e6066a3f03",
    ),
    "tests/fixtures/creation_review/silence_tail.wav": (
        256_044,
        "e743d2f97d7ffae81baacbc9b52c1214218f376b9ff6043dacc65f11f72d9f46",
    ),
    "tests/fixtures/creation_review/weak_drop_contrast.wav": (
        256_044,
        "7517fbdca6ae7c26d2ce0b2e37b65068e912ad7827e5bec099ae10423ea3f88c",
    ),
}
...
def main() -> int:
    ...
    for required in sorted(REQUIRED_CREATION_REVIEW_PATHS - candidate_names):
        failures.append((Path(required), "required Creation Review release file is missing"))
